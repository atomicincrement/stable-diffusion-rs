...
use crate::types::{TensorBf16, LATENT_CHANNELS, LATENT_HEIGHT, LATENT_WIDTH, OUTPUT_CHANNELS, OUTPUT_HEIGHT, OUTPUT_WIDTH};
use ndarray::Array4;
...
impl VaeDecoder {
    ...
    pub fn decode(&self, latent: Array4<TensorBf16>) -> Result<Array4<TensorBf16>, String> {
